...
5.extract parameters from fitm3
```{r set up}
#The following functions are adapted from the hBayesDM package (Ahn et al., 2017).
###########################################################################individual paramters#######################################################################
# load(".../fit_m3.RData")
# Extract from the Stan fit object
parVals <- rstan::extract(fit_m3, permuted = TRUE)
...
write.csv(allIndPars,file='IndPars_fit_m3.csv',row.names = FALSE)
...
writeMat('fit_m3_subwise_para.mat',alpha1=alpha1,alpha2=alpha2,beta=beta,tau=tau)
