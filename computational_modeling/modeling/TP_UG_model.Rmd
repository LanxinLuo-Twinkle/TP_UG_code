...
pars_m1 <- c('mu_alpha','mu_tau','sigma','alpha','tau','log_lik')
fit_m1 <- stan(file=paste0(getwd(),'/stan_model/m01.stan'), data=data_list,
                             pars    = pars_m1,
                             chains  = 3,
                             iter    = 4000,
                             warmup  = 2000,
...
save(fit_m1,file='./stan_output/fit_m1.RData')
...
pars_m2 <- c('mu_alpha1','mu_alpha2','mu_tau','sigma','alpha1','alpha2','tau','log_lik')
fit_m2 <- stan(file=paste0(getwd(),'/stan_model/m02.stan'), data=data_list,
                             pars    = pars_m2,
                             chains  = 3,
                             iter    = 4000,
                             warmup  = 2000,
...
#################################################################model fit & save model & plots#############################################################
save(fit_m2,file='./stan_output/fit_m2.RData')
...
fit_m3 <- stan(file=paste0(getwd(),'/stan_model/m03.stan'), data=data_list,
                             pars    = pars_m3,
                             chains  = 3,
                             iter    = 4000,
                             warmup  = 2000,
...
#################################################################model fit & save model & plots#############################################################
save(fit_m3,file='./stan_output/fit_m3.RData')
...
pars_m4 <- c('mu_alpha1','mu_alpha2','mu_beta','mu_tau','sigma','alpha1','alpha2','beta','tau','log_lik')
fit_m4 <- stan(file=paste0(getwd(),'/stan_model/m04.stan'), data=data_list,
                             pars    = pars_m4,
                             chains  = 3,
                             iter    = 4000,
                             warmup  = 2000,
...
#################################################################model fit & save model & plots#############################################################
save(fit_m4,file='./stan_output/fit_m4.RData')
