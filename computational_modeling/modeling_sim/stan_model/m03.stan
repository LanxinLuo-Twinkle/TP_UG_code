...
// Declare all parameters as vectors for vectorizing
  ...
  vector[4] mu_pr; //mean of the parameters,4 paras: weights for each party and a inverse temperature.
  vector<lower=0>[4] sigma; //variance of the parameters, 3 paras
